...
RTM_MCMC <- function(sensor, iteration, sza, vza, observed){
  ...
  par_min <- c(0, 1,  5,   0,   0,  2, 0,   0,    0)
  par_max <- c(7, 5, 60, 0.05, 0.05, 10, 4, 0.5,  0.1)
  #Likelihood function
...
land.sim[[1]] <- sim_ref(Landsat[[1]],sensor,land.sza.4.17,land.vza,land.ob.4.17)
...
land.sim[[2]] <- sim_ref(Landsat[[2]],sensor,land.sza.6.4,land.vza,land.ob.6.4)
...
land.sim[[3]] <- sim_ref(Landsat[[3]],sensor,land.sza.9.24,land.vza,land.ob.9.24)

#sumarize
#Landsat <- list(land.out.4.17, land.out.6.4, land.out.9.24)
#save(Landsat,file="Landsat.RData")
...
#plot(modi.out.4.7)
modi.sim[[1]] <- sim_ref(MODIS[[1]],sensor,modi.sza.4.7,modi.vza.4.7,modi.ob.4.7)
...
#plot(modi.out.4.16)
modi.sim[[2]] <- sim_ref(MODIS[[2]],sensor,modi.sza.4.16,modi.vza.4.16,modi.ob.4.16)
...
#plot(modi.out.4.24)
modi.sim[[3]] <- sim_ref(MODIS[[3]],sensor,modi.sza.4.24,modi.vza.4.24,modi.ob.4.24)
...
#plot(modi.out.4.25)
modi.sim[[4]] <- sim_ref(MODIS[[4]],sensor,modi.sza.4.25,modi.vza.4.25,modi.ob.4.25)
...
#plot(modi.out.4.29)
modi.sim[[5]] <- sim_ref(MODIS[[5]],sensor,modi.sza.4.29,modi.vza.4.29,modi.ob.4.29)
...
#plot(modi.out.5.6)
modi.sim[[6]] <- sim_ref(MODIS[[6]],sensor,modi.sza.5.6,modi.vza.5.6,modi.ob.5.6)
...
#plot(modi.out.5.8)
modi.sim[[7]] <- sim_ref(MODIS[[7]],sensor,modi.sza.5.8,modi.vza.5.8,modi.ob.5.8)
...
#plot(modi.out.5.11)
modi.sim[[8]] <- sim_ref(MODIS[[8]],sensor,modi.sza.5.11,modi.vza.5.11,modi.ob.5.11)
...
#plot(modi.out.5.21)
modi.sim[[9]] <- sim_ref(MODIS[[9]],sensor,modi.sza.5.21,modi.vza.5.21,modi.ob.5.21)
...
#plot(modi.out.5.27)
modi.sim[[10]] <- sim_ref(MODIS[[10]],sensor,modi.sza.5.27,modi.vza.5.27,modi.ob.5.27)
...
#plot(modi.out.6.28)
modi.sim[[11]] <- sim_ref(MODIS[[11]],sensor,modi.sza.6.28,modi.vza.6.28,modi.ob.6.28)
...
#plot(modi.out.7.5)
modi.sim[[12]] <- sim_ref(MODIS[[12]],sensor,modi.sza.7.5,modi.vza.7.5,modi.ob.7.5)
...
#plot(modi.out.7.10)
modi.sim[[13]] <- sim_ref(MODIS[[13]],sensor,modi.sza.7.10,modi.vza.7.10,modi.ob.7.10)
...
#plot(modi.out.7.16)
modi.sim[[14]] <- sim_ref(MODIS[[14]],sensor,modi.sza.7.16,modi.vza.7.16,modi.ob.7.16)
...
#plot(modi.out.7.21)
modi.sim[[15]] <- sim_ref(MODIS[[15]],sensor,modi.sza.7.21,modi.vza.7.21,modi.ob.7.21)
...
#plot(modi.out.7.25)
modi.sim[[16]] <- sim_ref(MODIS[[16]],sensor,modi.sza.7.25,modi.vza.7.25,modi.ob.7.25)
...
#plot(modi.out.8.12)
modi.sim[[17]] <- sim_ref(MODIS[[17]],sensor,modi.sza.8.12,modi.vza.8.12,modi.ob.8.12)
...
#plot(modi.out.8.18)
modi.sim[[18]] <- sim_ref(MODIS[[18]],sensor,modi.sza.8.18,modi.vza.8.18,modi.ob.8.18)
...
#plot(modi.out.9.7)
modi.sim[[19]] <- sim_ref(MODIS[[19]],sensor,modi.sza.9.7,modi.vza.9.7,modi.ob.9.7)
...
#plot(modi.out.9.15)
modi.sim[[20]] <- sim_ref(MODIS[[20]],sensor,modi.sza.9.15,modi.vza.9.15,modi.ob.9.15)
...
#plot(modi.out.10.19)
modi.sim[[21]] <- sim_ref(MODIS[[21]],sensor,modi.sza.10.19,modi.vza.10.19,modi.ob.10.19)
...
#plot(modi.out.10.21)
modi.sim[[22]] <- sim_ref(MODIS[[22]],sensor,modi.sza.10.21,modi.vza.10.21,modi.ob.10.21)
...
#plot(modi.out.10.24)
modi.sim[[23]] <- sim_ref(MODIS[[23]],sensor,modi.sza.10.24,modi.vza.10.24,modi.ob.10.24)
...
#plot(modi.out.11.1)
modi.sim[[24]] <- sim_ref(MODIS[[24]],sensor,modi.sza.11.1,modi.vza.11.1,modi.ob.11.1)
...
#plot(modi.out.11.4)
modi.sim[[25]] <- sim_ref(MODIS[[25]],sensor,modi.sza.11.4,modi.vza.11.4,modi.ob.11.4)
...
#plot(modi.out.11.9)
modi.sim[[26]] <- sim_ref(MODIS[[26]],sensor,modi.sza.11.9,modi.vza.11.9,modi.ob.11.9)
...
#plot(modi.out.11.13)
modi.sim[[27]] <- sim_ref(MODIS[[27]],sensor,modi.sza.11.13,modi.vza.11.13,modi.ob.11.13)
...
#plot(modi.out.11.21)
modi.sim[[28]] <- sim_ref(MODIS[[28]],sensor,modi.sza.11.21,modi.vza.11.21,modi.ob.11.21)
...
#plot(modi.out.11.23)
modi.sim[[29]] <- sim_ref(MODIS[[29]],sensor,modi.sza.11.23,modi.vza.11.23,modi.ob.11.23)
...
#plot(sent.out.4.3)
sent.sim[[1]] <- sim_ref(Sentinel[[1]],sensor,sent.sza.4.3,sent.vza,sent.ob.4.3)
...
#plot(sent.out.5.18)
sent.sim[[2]] <- sim_ref(Sentinel[[2]],sensor,sent.sza.5.18,sent.vza,sent.ob.5.18)
...
#plot(sent.out.6.7)
sent.sim[[3]] <- sim_ref(Sentinel[[3]],sensor,sent.sza.6.7,sent.vza,sent.ob.6.7)
...
#plot(sent.out.6.12)
sent.sim[[4]] <- sim_ref(Sentinel[[4]],sensor,sent.sza.6.12,sent.vza,sent.ob.6.12)
...
#plot(sent.out.6.17)
sent.sim[[5]] <- sim_ref(Sentinel[[5]],sensor,sent.sza.6.17,sent.vza,sent.ob.6.17)
...
#plot(sent.out.6.22)
sent.sim[[6]] <- sim_ref(Sentinel[[6]],sensor,sent.sza.6.22,sent.vza,sent.ob.6.22)
...
#plot(sent.out.7.7)
sent.sim[[7]] <- sim_ref(Sentinel[[7]],sensor,sent.sza.7.7,sent.vza,sent.ob.7.7)
...
#plot(sent.out.7.27)
sent.sim[[8]] <- sim_ref(Sentinel[[8]],sensor,sent.sza.7.27,sent.vza,sent.ob.7.27)
...
#plot(sent.out.8.1)
sent.sim[[9]] <- sim_ref(Sentinel[[9]],sensor,sent.sza.8.1,sent.vza,sent.ob.8.1)
...
#plot(sent.out.8.6)
sent.sim[[10]] <- sim_ref(Sentinel[[10]],sensor,sent.sza.8.6,sent.vza,sent.ob.8.6)
...
#plot(sent.out.8.26)
sent.sim[[11]] <- sim_ref(Sentinel[[11]],sensor,sent.sza.8.26,sent.vza,sent.ob.8.26)
...
#plot(sent.out.9.20)
sent.sim[[12]] <- sim_ref(Sentinel[[12]],sensor,sent.sza.9.20,sent.vza,sent.ob.9.20)
...
#plot(sent.out.9.25)
sent.sim[[13]] <- sim_ref(Sentinel[[13]],sensor,sent.sza.9.25,sent.vza,sent.ob.9.25)
...
#plot(sent.out.9.30)
sent.sim[[14]] <- sim_ref(Sentinel[[14]],sensor,sent.sza.9.30,sent.vza,sent.ob.9.30)
...
#plot(sent.out.10.5)
sent.sim[[15]] <- sim_ref(Sentinel[[15]],sensor,sent.sza.10.5,sent.vza,sent.ob.10.5)
...
#plot(sent.out.10.15)
sent.sim[[16]] <- sim_ref(Sentinel[[16]],sensor,sent.sza.10.15,sent.vza,sent.ob.10.15)
...
#plot(sent.out.11.4)
sent.sim[[17]] <- sim_ref(Sentinel[[17]],sensor,sent.sza.11.4,sent.vza,sent.ob.11.4)
...
#plot(sent.out.11.9)
sent.sim[[18]] <- sim_ref(Sentinel[[18]],sensor,sent.sza.11.9,sent.vza,sent.ob.11.9)
...
#plot(sent.out.11.29)
sent.sim[[19]] <- sim_ref(Sentinel[[19]],sensor,sent.sza.11.29,sent.vza,sent.ob.11.29)
sent.ob[[19]] <- sent.ob.11.29

#summarize
#Sentinel <- list(sent.out.4.3, sent.out.5.18, sent.out.6.7, sent.out.6.12, sent.out.6.17, sent.out.6.22, sent.out.7.7, sent.out.7.27, sent.out.8.1, sent.out.8.6, sent.out.8.26, sent.out.9.20, sent.out.9.25, sent.out.9.30, sent.out.10.5, sent.out.10.15, sent.out.11.4, sent.out.11.9, sent.out.11.29)
#save(Sentinel,file="Sentinel.RData")
plot(seq(0,0.6,length=100),seq(0,0.6,length=100),type="l",col="red")
for (i in 1:19) {
...
#LAI, N, Cab, Cm, Cw, Car, Cbrown, psoil
#LAI
LAI <- matrix(0,51,3)
for (i in 1:51) {
...
plot(LAI[,3],type="l",col=2, ylim=c(0,7))
lines(LAI[,2],col=2)
lines(LAI[,1],col=1)
#N
N <- matrix(0,51,3)
for (i in 1:51) {
  N[i,1] <- all.param[[i]]$param.50[2] 
  N[i,2] <- all.param[[i]]$param.2.5[2]
  N[i,3] <- all.param[[i]]$param.97.5[2] 
}
plot(N[,3],type="l",col=2,ylim=c(1,5))
lines(N[,2],col=2)
lines(N[,1],col=1)
#Cab
Cab <- matrix(0,51,3)
for (i in 1:51) {
  Cab[i,1] <- all.param[[i]]$param.50[3] 
  Cab[i,2] <- all.param[[i]]$param.2.5[3]
  Cab[i,3] <- all.param[[i]]$param.97.5[3] 
}
...
Cm <- matrix(0,51,3)
for (i in 1:51) {
  Cm[i,1] <- all.param[[i]]$param.50[4] 
  Cm[i,2] <- all.param[[i]]$param.2.5[4]
  Cm[i,3] <- all.param[[i]]$param.97.5[4] 
}
plot(Cm[,3],type="l",col=2,ylim=c(0,0.06))
lines(Cm[,2],col=2)
lines(Cm[,1],col=1)
...
Cw <- matrix(0,51,3)
for (i in 1:51) {
  Cw[i,1] <- all.param[[i]]$param.50[5] 
  Cw[i,2] <- all.param[[i]]$param.2.5[5]
  Cw[i,3] <- all.param[[i]]$param.97.5[5] 
}
plot(Cw[,3],type="l",col=2,ylim=c(0,0.06))
lines(Cw[,2],col=2)
lines(Cw[,1],col=1)
...
Car <- matrix(0,51,3)
for (i in 1:51) {
  Car[i,1] <- all.param[[i]]$param.50[6] 
  Car[i,2] <- all.param[[i]]$param.2.5[6]
  Car[i,3] <- all.param[[i]]$param.97.5[6] 
}
plot(Car[,3],type="l",col=2,ylim=c(0,10))
lines(Car[,2],col=2)
lines(Car[,1],col=1)
...
for (i in 1:51) {
  Cbrown[i,1] <- all.param[[i]]$param.50[7] 
  Cbrown[i,2] <- all.param[[i]]$param.2.5[7]
  Cbrown[i,3] <- all.param[[i]]$param.97.5[7] 
}
...
psoil <- matrix(0,51,3)
for (i in 1:51) {
  psoil[i,1] <- all.param[[i]]$param.50[8] 
  psoil[i,2] <- all.param[[i]]$param.2.5[8]
  psoil[i,3] <- all.param[[i]]$param.97.5[8] 
}
plot(psoil[,3],type="l",col=2,ylim=c(0,0.5))
lines(psoil[,2],col=2)
lines(psoil[,1],col=1)
...
DOY <- c(93, 97, 106, 107, 114, 115, 119,           #Apr
         126, 128, 131, 138, 141, 147,              #May
         155, 158, 163, 168, 173, 179,              #June
         186, 188, 191, 197, 202, 206, 208,         #July
         213, 218, 224, 230, 236,                   #Aug
         250, 258, 263, 267, 268, 273,              #Sep
         278, 288, 292, 294, 297,                   #Oct
         305, 308, 308, 313, 313, 317, 325, 327, 333)#Nov

LAI.random.walk <- State.space(LAI[,1], DOY, label = "LAI")
N.random.walk <- State.space(N[,1], DOY, label = "N")
...
Car.random.walk <- State.space(Car[,1], DOY, label = "Car")
Cbrown.random.walk <- State.space(Cbrown[,1], DOY, label = "Cbrown")
psoil.random.walk <- State.space(psoil[,1], DOY, label = "psoil")
```
